...
with col2:
    chosen_sa = st.multiselect(label="Sales Area", options=options_sa)


curr_fy = chosen_fy

filtered_omc_master = DataAnalysis.filter_data(df=st.session_state.omc_master, OMC=options_OMC, SA=chosen_sa)
